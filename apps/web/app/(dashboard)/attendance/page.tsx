      ...
      <div className="bg-gradient-to-r from-slate-900/90 to-slate-800/60 border border-slate-800 rounded-2xl p-5 flex items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-0.5">Friday, 5 September 2026 · 14:26 IST</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          <div className="text-center">
            <p className="text-xs text-slate-500">Checked In</p>
            <p className="text-sm font-bold text-white">09:02</p>
          </div>
          ...
          <tbody className="divide-y divide-slate-800/80">
            {filtered.map((att) => (
              <tr
                ...
                onClick={() => window.location.href = `/attendance/${att.id}`}
              >
                <td className="py-3.5 px-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-medium text-white">{att.employeeName}</span>
                  </div>
                </td>
