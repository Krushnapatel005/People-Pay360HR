...
__decorate([
    ...
    __metadata("design:type", Object)
], Department.prototype, "managerEmployeeId", void 0);
__decorate([
...
exports.DepartmentSchema.index({ companyId: 1, code: 1 }, { unique: true });
exports.DepartmentSchema.index({ companyId: 1, name: 1 }, { unique: true });
